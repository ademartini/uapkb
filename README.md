...
AI-first reference repository: Next.js scaffold with enforced quality gates, devcontainer parity, and smoke-gated fly.io deployment.
...
| `pnpm check`           | Full local gate (format, lint, typecheck, test) |
...
- `docs/devcontainer.md` — one container, three consumers
